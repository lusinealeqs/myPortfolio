...
const greeting = {
    username: "Lusine Aleksanyan",
    title: "Hi all, I'm Lusine",
    subTitle: emoji(
    ...
    experience: [
        {
            ...
            desc:
                "Changing lives of developers by organizing their dream classes.",
            descBullets: [
                "Organizing ReactJS classes",
                "Organizing HTML/CSS classes",
                "Organizing JavaScript classes",
            ],
        },
    ],
};
...
const openSource = {
    ...
    githubUserName: "lusinealeqs", // Change to your github username to view your profile in Contact Section.
